...
#ifndef CPP14_FEABHOS_BUFFER_H
#define CPP14_FEABHOS_BUFFER_H
...
namespace FeabhOS {
  ...
  namespace Utility {
    ...
    private:
      using Buffer_Ty   = std::array<T, sz>;
      using Iterator_Ty = typename Buffer_Ty::iterator;
